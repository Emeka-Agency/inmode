...
use App\Controller\ControleurAPI;
use App\Controller\ControleurBase;
use App\Controller\ControleurCommandes;
use App\Modeles\App;
...
{
    case route("api"):
        require_once("./Controleurs/API.php");
        return ControleurAPI::resolve($path_schema ?? []);
    case route("orders"):
