...
const ExoCoBioProtocols = ({  }:ExoCoBioProtocols) => {

    const videos = [
        {url: "https://inmodemd.fr/public/vids/exb_protocol_1.mp4", poster: "https://cdn.shopify.com/s/files/1/0313/4901/4660/files/Screenshot_2024-08-05_at_3.50.19_PM.png?v=1722887529"},
        {url: "https://inmodemd.fr/public/vids/exb_protocol_2.mp4", poster: "https://cdn.shopify.com/s/files/1/0313/4901/4660/files/Screenshot_2024-08-06_at_10.38.33_AM.png?v=1722955134"}
    ];
    ...
    function exocovio_videos_positions(i:number) {
        Array.from(containerRef.current?.parentElement?.querySelectorAll('.page_exocobio-protocols-videos-video') || [])
        .forEach((video, vi) => {
    ...
    React.useEffect(() => {
        document.getElementById("page_exocobio-protocols-videos")?.classList[canPlay || isDragging == false ? 'remove' : 'add']('dragging');
    }, [canPlay, isDragging]);

    React.useEffect(() => {
        Array.from(containerRef.current?.parentElement?.querySelectorAll('.page_exocobio-protocols-videos-video video') || [])
        .forEach((video, vi) => {
    ...
    return (
        <div id="page_exocobio-protocols">
            <h2>PROTOCOLES</h2>
            <div id="page_exocobio-protocols-carrousel">
                <div id="page_exocobio-protocols-videos_container">
                    ...
                    <div
                        id="page_exocobio-protocols-videos"
                        ref={containerRef}
...
interface ExoCoBioProtocols {

};

export default ExoCoBioProtocols;
